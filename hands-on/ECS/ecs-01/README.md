...
## image satırını değiştirmeyi unutma ECR/repository içine gir oradan kopyala  ## arn:aws:iam::837233063764:role/PolicyforECS (ECS den al)
```json
{
...
## subnet ve Sec_gr u değiştir (önceki cluster ın Networking ayarlarına gir ve oradan kopyala)
```bash
