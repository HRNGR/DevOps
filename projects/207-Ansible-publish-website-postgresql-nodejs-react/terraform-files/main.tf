...
resource "aws_iam_role" "ec2full" {
  ...
  managed_policy_arns = ["arn:aws:iam::aws:policy/AmazonEC2FullAccess"]   ## !!! EC2fullaccess policy ile iam role oluşturduk. Ama Çalıştırmadan önce eskisini sil
}
...
## Hatasız Apply dan sonra, Ansible-playbook yaparken permission hatası alabilirsin "chmod 400" yap. Ve tekrar dene.